...
def send_telegram_notification(message):
    ...
    try:
        ...
        # Se usa urllib.parse.quote para formatear correctamente los saltos de línea y emojis en la URL
...
def usage():
    ...
    print('      --postal-code <postal_code> (resolve location via postal code)')
...
def main():
    ...
    try:
        opts, _ = getopt.getopt(
            sys.argv[1:], 
            'hs:t:', 
            ['help', 'search=', 'time=', 'country=', 'postal-code=', 'min-price=', 'max-price=', 'telegram', 'notify']
        )
    ...
    try:
        ...
        # Nombre de archivo dinámico para no solapar filtros de precio
